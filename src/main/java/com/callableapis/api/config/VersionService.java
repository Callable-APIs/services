    ...
    private void loadVersionInfo() {
        try {
            ...
            if (is != null) {
                ...
                logger.info("Loaded version info from version.properties - Repo: " + repoName + ", Commit: " + gitCommitHashFull + ", Build: " + buildTime);
            } else {
                // Fallback: try to get git info from environment variables or system properties
                String envCommit = System.getenv("GIT_COMMIT_ID") != null ? System.getenv("GIT_COMMIT_ID") : System.getenv("GITHUB_SHA");
                ...
                repoName = System.getProperty("version.repo", 
                    System.getenv("GITHUB_REPOSITORY") != null ? System.getenv("GITHUB_REPOSITORY") : "Callable-APIs/services");
                ...
                logger.info("Using fallback version info - Repo: " + repoName + ", Commit: " + gitCommitHashFull + ", Build: " + buildTime);
            }
        } catch (IOException e) {
