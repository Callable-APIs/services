...
public class AuthenticatedResource {
    ...
    private String generateAuthenticatedHtml(String identity, String apiKey, String gitCommitHash, String shortCommitHash, String buildTime) {
        return "<!DOCTYPE html>" +
                "<html lang=\"en\">" +
                "<head>" +
                "<meta charset=\"utf-8\" />" +
                ...
                "<style>" +
                "body { font-family: system-ui, -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, 'Helvetica Neue', Arial, 'Noto Sans', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; margin: 0; padding: 2rem; line-height: 1.6; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh; }" +
                ".container { max-width: 1000px; margin: 0 auto; background: white; border-radius: 12px; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.1); overflow: hidden; }" +
                ...
                "a.button { display: inline-block; background: #2da44e; color: white; padding: 0.75rem 1.5rem; border-radius: 6px; text-decoration: none; font-weight: 500; transition: background-color 0.2s; }" +
                "a.button:hover { background: #1a7f37; }" +
                "a.button.secondary { background: #6c757d; }" +
                "a.button.secondary:hover { background: #545b62; }" +
                ...
                ".example-section { background: #e3f2fd; border: 1px solid #bbdefb; border-radius: 8px; padding: 1.5rem; margin: 2rem 0; }" +
                ...
                "<div class=\"endpoint\"><span class=\"method method-get\">GET</span>/api/v1/calendar/date</div>" +
                "<div class=\"endpoint\"><span class=\"method method-get\">GET</span>/api/v2/calendar/solar</div>" +
                "<div class=\"endpoint\"><span class=\"method method-get\">GET</span>/api/v2/calendar/moon</div>" +
                "</div>" +
                "<div class=\"api-card\">" +
                "<h3>👤 User Management</h3>" +
                "<p>Manage your API keys and account</p>" +
                "<div class=\"endpoint\"><span class=\"method method-get\">GET</span>/api/user/me</div>" +
                "<div class=\"endpoint\"><span class=\"method method-post\">POST</span>/api/user/key/rotate</div>" +
                "</div>" +
                "<div class=\"api-card\">" +
                "<h3>💚 Health Check</h3>" +
                ...
                "<a href=\"/api/user/key/rotate\" class=\"button\" onclick=\"return confirm('Are you sure you want to rotate your API key? This will invalidate your current key.')\">🔄 Rotate API Key</a>" +
                "</div>" +
                "</div>" +
