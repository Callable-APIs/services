...
/**
 * Root resource that serves HTML landing page.
 * The infra agent has confirmed that / can return HTML since it's hit directly by browsers.
 */
@Path("/")
public class RootResource {
    ...
    public Response getRootPage() {
        ...
        // Redirect to the servlet-mapped path which serves the HTML landing page
