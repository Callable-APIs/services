<%@ page contentType="text/html;charset=UTF-8" language="java" %>
  <%@ page import="java.util.Map" %>
    <% // Get authentication status from the model Boolean isAuthenticated=(Boolean)
      request.getAttribute("isAuthenticated"); String identity=(String) request.getAttribute("identity"); Boolean
      hasBearerToken=(Boolean) request.getAttribute("hasBearerToken"); if (isAuthenticated==null) isAuthenticated=false;
      if (identity==null) identity="" ; if (hasBearerToken==null) hasBearerToken=false; %>
      <!doctype html>
      <html lang="en">
        ...
        <div class="container">
          <div class="header">
            ...
            <div style="margin-top: 1rem;">
              <span class="status-badge <%= isAuthenticated ? " status-authenticated" : "status-unauthenticated" %>">
                <%= isAuthenticated ? "✅ Authenticated as " + identity : "🔒 Not Authenticated" %>
              </span>
            </div>
          </div>
          ...
          <div class="content">
            <% if (isAuthenticated) { %>
              <!-- Service Discovery Page for Authenticated Users -->
              <h2>🎯 Service Discovery</h2>
              <p>Welcome back! Here are all available API endpoints and services.</p>
              ...
              <div class="api-grid">
                <div class="api-card">
                  ...
                  <p><strong>Rate Limit:</strong> 10 QPS per API key</p>
                </div>

                <div class="api-card">
                  <h3>👤 User Management</h3>
                  <p>Manage your API keys and account information.</p>
                  <div class="endpoint">
              ...
              <h3>🧪 Test Your API</h3>
              <p>Try calling the calendar endpoint with your Bearer token:</p>
              <pre><code>curl -H "Authorization: Bearer YOUR_API_KEY" \
https://api.callableapis.com/api/v1/calendar/date</code></pre>

              <h3>🔄 Rotate Your API Key</h3>
              <p>Generate a new API key for enhanced security:</p>
...
https://api.callableapis.com/api/user/key/rotate</code></pre>
                ...
                <div
                  style="background: #f0f8ff; border: 1px solid #b3d9ff; border-radius: 6px; padding: 1rem; margin: 2rem 0;">
