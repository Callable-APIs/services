 ...
 * This test ensures we never regress to returning JSON from the callback endpoint.
 */
public class OIDCCallbackRegressionTest {
    ...
    public void testCallbackNeverReturnsJson() {
        ...
        // "The redirect back from github to callableapis goes to a page that just renders the json identity"
    ...
    public void testCallbackRedirectsToAuthenticatedPage() {
        ...
        // 3. Callback should redirect to /api/authenticated with identity and apiKey parameters
        // 4. Authenticated page should show user-friendly HTML with API key and examples
    ...
    public void testOIDCFlowEndToEndBehavior() {
        ...
        // 2. GitHub redirects back with code -> callback processes and redirects to authenticated page
    ...
    public void testCallbackSecurityValidation() {
        ...
        // - No sensitive data should be exposed in URLs (though API key is in URL for now)
